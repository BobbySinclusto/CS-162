...
/********************************************************
** Function: get_input_wasd()
** Description: gets input from the user, making sure it is wasd
** Input: prompt
** Pre-Conditions: none
** Post-Conditions: returns the choice that the user chooses
********************************************************/
char get_input_wasd(string, bool);
